...
func (_u *ProfileUpdate) SetNickname(v string) *ProfileUpdate {
	_u.mutation.SetNickname(v)
	return _u
}

// SetNillableNickname sets the "nickname" field if the given value is not nil.
func (_u *ProfileUpdate) SetNillableNickname(v *string) *ProfileUpdate {
	if v != nil {
		_u.SetNickname(*v)
	}
	return _u
...
func (_u *ProfileUpdate) SetUserID(id int64) *ProfileUpdate {
...
// SetNickname sets the "nickname" field.
func (_u *ProfileUpdateOne) SetNickname(v string) *ProfileUpdateOne {
	_u.mutation.SetNickname(v)
	return _u
}

// SetNillableNickname sets the "nickname" field if the given value is not nil.
func (_u *ProfileUpdateOne) SetNillableNickname(v *string) *ProfileUpdateOne {
	if v != nil {
		_u.SetNickname(*v)
	}
	return _u
...
// SetUserID sets the "user" edge to the User entity by ID.
func (_u *ProfileUpdateOne) SetUserID(id int64) *ProfileUpdateOne {
	_u.mutation.SetUserID(id)
	return _u
}
