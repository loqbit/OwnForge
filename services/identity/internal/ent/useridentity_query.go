...
func (_q *UserIdentityQuery) QueryAuthorizations() *UserAppAuthorizationQuery {
...
func (_q *UserIdentityQuery) QuerySSOSessions() *SsoSessionQuery {
...
func (_q *UserIdentityQuery) QuerySessions() *SessionQuery {
...
func (_q *UserIdentityQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserIdentityQuery) FirstIDX(ctx context.Context) int {
...
func (_q *UserIdentityQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserIdentityQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *UserIdentityQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *UserIdentityQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserIdentityQuery) WithAuthorizations(opts ...func(*UserAppAuthorizationQuery)) *UserIdentityQuery {
	query := (&UserAppAuthorizationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserIdentityQuery) WithSSOSessions(opts ...func(*SsoSessionQuery)) *UserIdentityQuery {
	query := (&SsoSessionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserIdentityQuery) WithSessions(opts ...func(*SessionQuery)) *UserIdentityQuery {
	query := (&SessionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(useridentity.FieldProvider).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.UserIdentity.Query().
//		Select(useridentity.FieldProvider).
//		Scan(ctx, &v)
...
func (_q *UserIdentityQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserIdentity, error) {
	...
	if query := _q.withAuthorizations; query != nil {
		if err := _q.loadAuthorizations(ctx, query, nodes,
			func(n *UserIdentity) { n.Edges.Authorizations = []*UserAppAuthorization{} },
			func(n *UserIdentity, e *UserAppAuthorization) {
	...
	if query := _q.withSSOSessions; query != nil {
		if err := _q.loadSSOSessions(ctx, query, nodes,
			func(n *UserIdentity) { n.Edges.SSOSessions = []*SsoSession{} },
			func(n *UserIdentity, e *SsoSession) { n.Edges.SSOSessions = append(n.Edges.SSOSessions, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSessions; query != nil {
		if err := _q.loadSessions(ctx, query, nodes,
			func(n *UserIdentity) { n.Edges.Sessions = []*Session{} },
			func(n *UserIdentity, e *Session) { n.Edges.Sessions = append(n.Edges.Sessions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserIdentityQuery) loadAuthorizations(ctx context.Context, query *UserAppAuthorizationQuery, nodes []*UserIdentity, init func(*UserIdentity), assign func(*UserIdentity, *UserAppAuthorization)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*UserIdentity)
	for i := range nodes {
	...
	query.Where(predicate.UserAppAuthorization(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(useridentity.AuthorizationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_identity_authorizations
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_identity_authorizations" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_identity_authorizations" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserIdentityQuery) loadSSOSessions(ctx context.Context, query *SsoSessionQuery, nodes []*UserIdentity, init func(*UserIdentity), assign func(*UserIdentity, *SsoSession)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*UserIdentity)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.SsoSession(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(useridentity.SSOSessionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_identity_sso_sessions
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_identity_sso_sessions" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_identity_sso_sessions" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserIdentityQuery) loadSessions(ctx context.Context, query *SessionQuery, nodes []*UserIdentity, init func(*UserIdentity), assign func(*UserIdentity, *Session)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*UserIdentity)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Session(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(useridentity.SessionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_identity_sessions
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_identity_sessions" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_identity_sessions" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *UserIdentityQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(useridentity.Table, useridentity.Columns, sqlgraph.NewFieldSpec(useridentity.FieldID, field.TypeInt))
	_spec.From = _q.sql
...
func (_q *UserIdentityQuery) ForUpdate(opts ...sql.LockOption) *UserIdentityQuery {
...
func (_q *UserIdentityQuery) ForShare(opts ...sql.LockOption) *UserIdentityQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
