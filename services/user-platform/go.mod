...
// Force the monolithic genproto to a post-split version (a stub without the
// old googleapis/{rpc,api} subpackages). Without this, github.com/tjfoc/gmsm's
// ancient grpc@v1.31.0 pulls genproto@2019, which conflicts with the split
...
require (
	...
	github.com/luckysxx/common/proto v1.3.1
...
require (
	...
	github.com/luckysxx/common/rpc v0.1.2
