...
type Snippet struct {
	...
	// Content type: code for snippets, note for notes, file for uploads
	Type snippet.Type `json:"type,omitempty"`
	// Title
	Title string `json:"title,omitempty"`
	// Text content for code or notes
	Content string `json:"content,omitempty"`
	// Object-storage path for the file
	FileURL string `json:"file_url,omitempty"`
	// File size in bytes
	FileSize int64 `json:"file_size,omitempty"`
	// File MIME type
	MimeType string `json:"mime_type,omitempty"`
	// Programming language or file-type marker
	Language string `json:"language,omitempty"`
	// Owning group ID
	GroupID *int64 `json:"group_id,omitempty"`
	// Sort weight within the group; lower values appear first and support drag-and-drop ordering
	SortOrder int `json:"sort_order,omitempty"`
	// Whether the snippet is favorited
	IsFavorite bool `json:"is_favorite,omitempty"`
	// Deletion time; a non-nil value means the snippet is in the trash (soft deleted)
