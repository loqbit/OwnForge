...
func (_q *TemplateQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *TemplateQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *TemplateQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *TemplateQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *TemplateQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *TemplateQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TemplateQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(template.Table, template.Columns, sqlgraph.NewFieldSpec(template.FieldID, field.TypeInt64))
	_spec.From = _q.sql
